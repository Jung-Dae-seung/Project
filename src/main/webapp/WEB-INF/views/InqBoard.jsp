...
<body>
	...
	<div class="container">
		...
		<div class="row">
						...
						<tr>
							...
							<td><c:if test="${vo.open eq 'N'}">
									...
									<sec:authorize access="isAuthenticated()">
										...
										<c:choose>
											<c:when
												test="${info.username==vo.writer || role=='ROLE_ADMIN'}">
												<script>
													$(".secret").remove();
												</script>
												<i class='bi bi-lock'></i><a href="${vo.bno }" class="move">${vo.title }</a>
			...
			<div class="text-center">
				...
				<sec:authorize access="isAuthenticated()">
					<a href="inqwrite" class="btn btn-primary pull-right">글쓰기</a>
				</sec:authorize>
				<sec:authorize access="!isAuthenticated()">
	...
	<form action="InqBoard" method="get" id="actionForm">
