		...
		<div class="row">
			<form method="post"  action="updateAction.jsp">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="글 제목" name="freeBoardTitle" maxlength="50" value=""/></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="글 내용" name="freeBoardContent" maxlength="2000"  style="height: 350px;"/></textarea>
						</tr>
					</tbody>
				</table>
